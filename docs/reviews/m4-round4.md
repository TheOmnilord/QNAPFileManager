...
45 findings, all accepted and fixed. Final Linux CI run 34784858203 at 40d990f: all five jobs green (the flock
lock and the certificate lock both exercised under -race).
...
crash between the two renames self-heals at the next start. Seventh verification push: 40d990f.
